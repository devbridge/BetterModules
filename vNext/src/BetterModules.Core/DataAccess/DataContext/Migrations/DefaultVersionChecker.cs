...
namespace BetterModules.Core.DataAccess.DataContext.Migrations
{
    public class DefaultVersionChecker : IVersionChecker
    {
        ...
        public DefaultVersionChecker(IUnitOfWork unitOfWork, 
            ...
            ILoggerFactory loggerFactory)
        {
            ...
            logger = loggerFactory.CreateLogger(typeof (DefaultVersionChecker).FullName);
            ...
            {
                logger.LogError("DefaultVersionChecker loading from file / database failed.", ex);
            }
        }
        ...
        public bool VersionExists(string moduleName, long version)
        {
            ...
            {
                logger.LogError("DefaultVersionChecker version check failed.", ex);
                return false;
            }
        }
        ...
        private void LoadFromDatabase()
        {
            ...
            logger.LogVerbose("Loading migration files list from database");
        ...
        private bool LoadFromFile()
        {
            ...
            {
                logger.LogVerbose("Loading migration files list from cache file");
        ...
        private void AddVersion(string moduleName, long version, bool writeToFile)
        {
            ...
            {
                logger.LogError("DefaultVersionChecker version adding failed.", ex);
            }
        }
