...
namespace BetterModules.Core.Models
{
        ...
        where TEntity : IEntity
    {
        ...
        protected EntityMapBase(string moduleName, IModulesRegistration modulesRegistration)
        {
        ...
        protected EntityMapBase(Type moduleDescriptorType, IModulesRegistration modulesRegistration)
        {
            var currentModule = modulesRegistration.GetModules()
                    .FirstOrDefault(
        ...
        /// Initializes a new instance of the <see cref="EntityMapBase{TEntity}"/> class.
        /// </summary>
        protected EntityMapBase(IModulesRegistration modulesRegistration)
        {
